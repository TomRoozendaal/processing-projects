...
public class cellularAutomata_1D extends PApplet {
...
int c1 = color(25); // ON cell color
int c2 = color(220); // OFF cell color
...
public void calcGeneration(int y){
  for (int x = 0; x < grid.length; x++) {
...
public boolean calcRule(boolean l, boolean c, boolean r){
  if (rule < 0 ){
  ...
  public void settings() {  size(602, 400); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "cellularAutomata_1D" };
    if (passedArgs != null) {
